...
public class ConfigurableMessageHandler : DelegatingHandler
{
    ...
    private static readonly string UserAgentSuffix = "VuforiaPortal-api-dotnet-client/" + ConfigurableMessageHandler.ApiVersion;
    ...
    protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
    {
        ...
        bool loggable = IsLoggingEnabled && ConfigurableMessageHandler.Logger.IsDebugEnabled;
        int triesRemaining = NumTries;
        int redirectRemaining = NumRedirects;
        request.Headers.Add("User-Agent", (ApplicationName == null ? "" : ApplicationName + " ") + ConfigurableMessageHandler.UserAgentSuffix);
        ...
        do
        {
            ...
            else
            {
                ...
                lock (unsuccessfulResponseHandlersLock)
                    list2 = unsuccessfulResponseHandlers.ToList<IHttpUnsuccessfulResponseHandler>();
