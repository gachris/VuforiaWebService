...
public class TargetListResource
{
    ...
    public virtual ListRequest List(ServerAccessKeys keys) => new ListRequest(_service, keys);
    ...
    public virtual GetRequest Get(ServerAccessKeys keys, string targetId) => new GetRequest(_service, keys, targetId);
    ...
    public virtual InsertRequest Insert(ServerAccessKeys keys, PostTrackableRequest body) => new InsertRequest(_service, keys, body);
    ...
    public virtual DeleteRequest Delete(ServerAccessKeys keys, string targetId) => new DeleteRequest(_service, keys, targetId);
    ...
    public virtual CheckSimilarRequest CheckSimilar(ServerAccessKeys keys, string targetId) => new CheckSimilarRequest(_service, keys, targetId);
    ...
    public virtual RetrieveTargetSummaryReportRequest RetrieveTargetSummaryReport(ServerAccessKeys keys, string targetId) => new RetrieveTargetSummaryReportRequest(_service, keys, targetId);
    ...
    public virtual GetDatabaseSummaryReportRequest GetDatabaseSummaryReport(ServerAccessKeys keys) => new GetDatabaseSummaryReportRequest(_service, keys);
    ...
    public class ListRequest : TargetBaseServiceRequest<VuforiaGetAllResponse>
    {
        ...
        /// <param name="service">The client service used for making requests.</param>
        /// <param name="keys">The database access keys required for authorization.</param>
        public ListRequest(IClientService service, ServerAccessKeys keys) : base(service, keys)
        {
        }
    ...
    public class GetRequest : TargetBaseServiceRequest<VuforiaRetrieveResponse>
    {
        ...
        /// <param name="keys">The database access keys required for authorization.</param>
        /// <param name="targetId">The ID of the target to get. To retrieve target IDs, call the <see cref="List"/> method.</param>
        public GetRequest(IClientService service, ServerAccessKeys keys, string targetId) : base(service, keys)
        {
            TargetId = targetId;
        }
    ...
    public class InsertRequest : TargetBaseServiceRequest<VuforiaPostResponse>
    {
        ...
        /// <param name="keys">The database access keys required for authorization.</param>
        /// <param name="body">The target to insert.</param>
        public InsertRequest(IClientService service, ServerAccessKeys keys, PostTrackableRequest body) : base(service, keys)
        {
            Body = body;
        }
    ...
    public class DeleteRequest : TargetBaseServiceRequest<VuforiaDeleteResponse>
    {
        ...
        /// <param name="keys">The database access keys required for authorization.</param>
        /// <param name="targetId">The ID of the target to delete. To retrieve target IDs, call the <see cref="List"/> method.</param>
        public DeleteRequest(IClientService service, ServerAccessKeys keys, string targetId) : base(service, keys)
        {
            TargetId = targetId;
        }
    ...
    public class CheckSimilarRequest : TargetBaseServiceRequest<VuforiaCheckSimilarResponse>
    {
        ...
        /// <param name="keys">The database access keys required for authorization.</param>
        /// <param name="targetId">The ID of the target to check for similarity. To retrieve target IDs, call the <see cref="List"/> method.</param>
        public CheckSimilarRequest(IClientService service, ServerAccessKeys keys, string targetId) : base(service, keys)
        {
            TargetId = targetId;
        }
    ...
    public class RetrieveTargetSummaryReportRequest : TargetBaseServiceRequest<VuforiaRetrieveTargetSummaryReportResponse>
    {
        ...
        /// <param name="keys">The database access keys required for authorization.</param>
        /// <param name="targetId">The ID of the target to retrieve the summary report for. To retrieve target IDs, call the <see cref="List"/> method.</param>
        public RetrieveTargetSummaryReportRequest(IClientService service, ServerAccessKeys keys, string targetId) : base(service, keys)
        {
            TargetId = targetId;
        }
    ...
    public class GetDatabaseSummaryReportRequest : TargetBaseServiceRequest<VuforiaGetDatabaseSummaryReportResponse>
    {
        ...
        /// <param name="service">The client service used for making requests.</param>
        /// <param name="keys">The database access keys required for authorization.</param>
        public GetDatabaseSummaryReportRequest(IClientService service, ServerAccessKeys keys) : base(service, keys)
        {
        }
