...
namespace VuforiaWebService.Api.Target
{
    ...
    public class TargetListResource
    {
        ...
        {
            return new DeleteRequest(service, keys, targetId);
        }
        ...
        {
            return new GetRequest(service, keys, targetId);
        }
        ...
        public class GetRequest : TargetBaseServiceRequest<VuforiaRetrieveResponse>
        {
            ...
            protected override void InitParameters()
            {
                ...
                this.RequestParameters.Add("targetId", new Parameter
                {
                    Name = "targetId",
                    IsRequired = true,
                    ParameterType = "path",
